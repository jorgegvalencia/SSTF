<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-27 15:32:00
         compiled from "./templates/registro_step1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:992855000553de75e9db2d5-96368046%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a59af0cadfda3eee5b7cdf867124fc2ae290cbe' => 
    array (
  ...
  'nocache_hash' => '992855000553de75e9db2d5-96368046',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_553de75ecdb6d1_66361580',
  'variables' => 
  array (
    'usernameError' => 0,
    'nameError' => 0,
...
<?php if ($_valid && !is_callable('content_553de75ecdb6d1_66361580')) {function content_553de75ecdb6d1_66361580($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container">
		...
		<hr>
		<form class="row form-signin" method="post" action="registro.php">
			<!-- Datos personales -->
			<div class="form-left col-md-offset-4 col-md-4">
				...
				<div class="form-group">
					<label>Email*</label>
					<input type="text" class="form-control input-sm" id="Email" name="Email" placeholder="address@example.com" required>
				...
				<a href="index.html" class="btn btn-default">Volver a inicio</a>
			</div>
		</div>
	</form>
	<?php echo '<script'; ?>
